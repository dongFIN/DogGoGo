function Box (target_in,main_x,main_y,Serial) {
    ...
    var animationDuration = (Math.abs(goalx-starx)+Math.abs(goaly-stary))*30;//快慢
    ...
    function flow() {
      ...
      if(flowmode==0){
        rotatenum=yPosition*0.6;
      }else if(flowmode==2){
        rotatenum=(1-positionInAnimation)*yPosition*0.6;//xPosition*0.2/(1-positionInAnimation); 
      }else if(flowmode==3){
        rotatenum=positionInAnimation*yPosition*0.6;
      }
      ...
      if (positionInAnimation <= 1){
        ...
        if(flowmode==0||flowmode==3){
            ...
            animationDuration = (Math.abs(goalx-starx)+Math.abs(goaly-stary))*30;
            animationStartTime = Date.now();
            requestAnimationFrame(flow);            
        }
      }
